      ...
      <header className="border-line/70 sticky top-0 z-50 border-b bg-[#040703]/70 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-[1400px] items-center justify-between gap-4 px-5 sm:px-8">
                ...
                <Link
                  ...
                  className={`flex items-center gap-2 rounded-full px-3.5 py-2 text-sm font-semibold transition-colors ${
                    isActive(n.href)
                      ...
                      : "text-white/55 hover:bg-[#12290d] hover:text-white"
                  }`}
                >
                  <NavIcon name={n.icon} />
                  {n.label}
          ...
          <div className="flex items-center gap-2.5">
            <span className="border-line hidden items-center gap-2 rounded-full border px-3.5 py-2 text-xs font-semibold text-white/60 lg:inline-flex">
            ...
            {NAV.map((n) => (
              <Link
                ...
                className={`flex items-center gap-2 rounded-xl px-4 py-3 text-sm font-semibold ${
                  isActive(n.href) ? "bg-white text-[#040703]" : "text-white/70 hover:bg-[#12290d]"
                }`}
              >
                <NavIcon name={n.icon} />
                {n.label}
